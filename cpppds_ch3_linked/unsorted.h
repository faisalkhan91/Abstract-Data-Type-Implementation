...
public:
  ...
  bool IsThere(ItemType&, bool&);                                 // NewStuff
  ...
  ItemType SplitLists(UnsortedType list, ItemType& item, UnsortedType& list1, UnsortedType& list2);     //NewStuff
  // Function:       Divides list into two lists according to the key of the item.
